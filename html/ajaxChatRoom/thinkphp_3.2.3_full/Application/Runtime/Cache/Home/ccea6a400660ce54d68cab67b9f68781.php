<?php if (!defined('THINK_PATH')) exit();?><html lang="zh-CN">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin"method="post" action="/ajaxChatRoom/thinkphp_3.2.3_full/index.php/Home/Index/login">
      ...
      <a href="<?php echo U('Register/index');?>">Register your account</a>
